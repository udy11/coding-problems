...
sols = []
for z in range(4, n):
    for yc in pellgeq(8, z**2, n // 2):
        y, c = yc
        b = y - 3 * c
        a = (z - b - c) // 2
        if 1 < c < n // 2 and 1 < a and a < b and b < c and (z - b - c) & 1 == 0 and a + b > c:
            sols.append((a + b + c, a, b, c))
    for yc in pellgeq(24, z**2, n // 2):
        y, c = yc
        b = y - 5 * c
        a = (z - b - c) // 2
        if 1 < c < n // 2 and 1 < a and a < b and b < c and (z - b - c) & 1 == 0 and a + b > c:
